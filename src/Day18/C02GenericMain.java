...
class Person
{
	...
	String age;
	char gender;
	Person(String name, String age, char gender)
	{
		this.name = name;
		this.age = age;
		this.gender = gender;
...
class Man extends Person
{
	...
	Man(String name, String age, char gender) 
	{
...
{
	Woman(String name, String age, char gender)
	{
		super(name, age, gender);
	}
...
public class C02GenericMain {
	...
	public static void main(String[] args) {
		...
		couple2.ShowInfo();
		System.out.println();
//		Couple<Man,Dog> couple3 = new Couple<Man,Dog>(new Man(" 철수","20 ", 'M') , new Dog("포메라니안"));
//		couple3.ShowInfo();
